...
• Для всех игроков должны быть установлены реальные роли (командой <code>/setrealrole</code>)
...
Используйте команду <code>/setrealrole %s &lt;ID_игрока&gt; &lt;роль&gt;</code> для установки ролей.

<b>Пример:</b> <code>/setrealrole %s %s demon</code>`,
